...
ADD https://github.com/livspaceeng/zeebe-kinesis-exporter/releases/download/0.4/zeebe-kinesis-exporter-0.4-uber.jar /usr/local/zeebe/lib/zeebe-kinesis-exporter.jar
