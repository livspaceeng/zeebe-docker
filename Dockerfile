...
ADD https://github.com/livspaceeng/zeebe-kinesis-exporter/releases/download/0.1/zeebe-kafka-exporter-1.2.0-SNAPSHOT-uber.jar /usr/local/zeebe/lib/zeebe-kafka-exporter.jar
